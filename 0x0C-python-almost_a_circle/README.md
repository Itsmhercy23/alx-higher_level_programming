...
In this project, I was able to encapsulated skills in Python object-oriented programming
...
The three classes involved utilizing the following Python tools are:
* Import
* Exceptions
* Private attributes
* Getter/setter
